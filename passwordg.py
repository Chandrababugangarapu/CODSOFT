...
length = Label(root, text="Select the Length of Your Password :- ", fg="green", bg="beige", font=("ubuntu", 12))
...
result_lable = Label(root, text="Generated Password Here :- ", bg="beige", fg="green", font=("ubuntu", 12))
